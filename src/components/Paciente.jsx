...
const Paciente = ({ nombre, email, fecha, propietario, sintomas, id, setPaciente, eliminarPaciente }) => {
    ...
    /*useEffect(() => {
        console.log('el comp paci esta listo')
    }, [])*/
    ...
    return (
        <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
            ...
            <div className="flex justify-between mt-10">
                ...
                onClick={() => setPaciente({ nombre, email, fecha, propietario, sintomas, id }) }>
                    Editar
                </button>
                <button 
                type="button"
